...
export const goals = {
  hyrox: {
    ...
    raceDate: "2026-12-13",
    raceDateDisplay: "dec 13–14, 2026",
    raceLocation: "anaheim, ca",
    trainingStart: "2026-01-01",
  },
  bodyFat: {
    label: "body fat",
    description: "stay under 15%",
    current: 13.3,
    target: 15,
    lastMeasured: "may 9, 2025",
    nextScan: "mar 13",
    unit: "%",
  },
  dunk: {
...
export const lifts: Lift[] = [
  { label: "bench", value: 230, previous: 225, unit: "lbs" },
  { label: "squat", value: 325, previous: 315, unit: "lbs" },
